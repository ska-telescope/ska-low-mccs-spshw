...
Physically, the optical fibres from the station are routed to the RPF and CPF, where they are digitised and
...
signal to the optical signal arriving at the RPF — require power, PaSD status can be a good indicator of the
