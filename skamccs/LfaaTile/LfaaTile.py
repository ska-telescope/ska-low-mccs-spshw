# -*- coding: utf-8 -*-
#
# This file is part of the LfaaTile project
#
#
#
...
# PROTECTED REGION END #    //  LfaaTile.additionnal_import

__all__ = ["LfaaTile", "main"]


class LfaaTile(SKABaseDevice):
    """
    The Tile Device represents the TANGO interface to a Tile (TPM) unit
    ...
    **Properties:**
    ...
    # PROTECTED REGION ID(LfaaTile.class_variable) ENABLED START #
    # PROTECTED REGION END #    //  LfaaTile.class_variable
    ...
    def init_device(self):
        """Initialises the attributes and properties of the LfaaTile."""
        SKABaseDevice.init_device(self)
        # PROTECTED REGION ID(LfaaTile.init_device) ENABLED START #
        ...
        # PROTECTED REGION END #    //  LfaaTile.init_device

    def always_executed_hook(self):
        """Method always executed before any TANGO command is executed."""
        # PROTECTED REGION ID(LfaaTile.always_executed_hook) ENABLED START #
        # PROTECTED REGION END #    //  LfaaTile.always_executed_hook
    ...
    def delete_device(self):
        ...
        """
        # PROTECTED REGION ID(LfaaTile.delete_device) ENABLED START #
        # PROTECTED REGION END #    //  LfaaTile.delete_device
    ...
    def read_tileId(self):
        # PROTECTED REGION ID(LfaaTile.tileId_read) ENABLED START #
        """Return the tileId attribute."""
        return self._tile_id
        # PROTECTED REGION END #    //  LfaaTile.tileId_read

    def write_tileId(self, value):
        # PROTECTED REGION ID(LfaaTile.tileId_write) ENABLED START #
        """Set the tileId attribute."""
        self._tile_id = value
        # PROTECTED REGION END #    //  LfaaTile.tileId_write

    def read_logicalTpmId(self):
        # PROTECTED REGION ID(LfaaTile.logicalTpmId_read) ENABLED START #
        """Return the logicalTpmId attribute."""
        return self._logical_tpm_id
        # PROTECTED REGION END #    //  LfaaTile.logicalTpmId_read

    def write_logicalTpmId(self, value):
        # PROTECTED REGION ID(LfaaTile.logicalTpmId_write) ENABLED START #
        """Set the logicalTpmId attribute."""
        self._logical_tpm_id = value
        # PROTECTED REGION END #    //  LfaaTile.logicalTpmId_write

    def read_subarrayId(self):
        # PROTECTED REGION ID(LfaaTile.subarrayId_read) ENABLED START #self._tile_id
        """Return the subarrayId attribute."""
        return self._subarray_id
        # PROTECTED REGION END #    //  LfaaTile.subarrayId_read

    def write_subarrayId(self, value):
        # PROTECTED REGION ID(LfaaTile.subarrayId_write) ENABLED START #
        """Set the subarrayId attribute."""
        self._subarray_id = value
        # PROTECTED REGION END #    //  LfaaTile.subarrayId_write

    def read_ipAddress(self):
        # PROTECTED REGION ID(LfaaTile.ipAddress_read) ENABLED START #
        """Return the ipAddress attribute."""
        return self._ip_address
        # PROTECTED REGION END #    //  LfaaTile.ipAddress_read

    def write_ipAddress(self, value):
        # PROTECTED REGION ID(LfaaTile.ipAddress_write) ENABLED START #
        """Set the ipAddress attribute."""
        self._ip_address = value
        # PROTECTED REGION END #    //  LfaaTile.ipAddress_writeself._tile_id

    def read_lmcIp(self):
        # PROTECTED REGION ID(LfaaTile.lmcIp_read) ENABLED START #
        """Return the lmcIp attribute."""
        return self._lmc_ip
        # PROTECTED REGION END #    //  LfaaTile.lmcIp_read

    def write_lmcIp(self, value):
        # PROTECTED REGION ID(LfaaTile.lmcIp_write) ENABLED START #
        """Set the lmcIp attribute."""
        self._lmc_ip = value
        # PROTECTED REGION END #    //  LfaaTile.lmcIp_write

    def read_lmcPort(self):
        # PROTECTED REGION ID(LfaaTile.lmcPort_read) ENABLED START #
        """Return the lmcPort attribute."""
        return self._lmc_port
        # PROTECTED REGION END #    //  LfaaTile.lmcPort_read

    def write_lmcPort(self, value):
        # PROTECTED REGION ID(LfaaTile.lmcPort_write) ENABLED START #
        """Set the lmcPort attribute."""
        self._lmc_port = value
        # PROTECTED REGION END #    //  LfaaTile.lmcPort_write

    def read_cspDestinationIp(self):
        # PROTECTED REGION ID(LfaaTile.cspDestinationIp_read) ENABLED START #
        """Return the cspDestinationIp attribute."""
        return self._csp_destination_ip
        # PROTECTED REGION END #    //  LfaaTile.cspDestinationIp_readself._tile_id

    def write_cspDestinationIp(self, value):
        # PROTECTED REGION ID(LfaaTile.cspDestinationIp_write) ENABLED START #
        """Set the cspDestinationIp attribute."""
        self._csp_destination_ip = value
        # PROTECTED REGION END #    //  LfaaTile.cspDestinationIp_write

    def read_cspDestinationMac(self):
        # PROTECTED REGION ID(LfaaTile.cspDestinationMac_read) ENABLED START #
        """Return the cspDestinationMac attribute."""
        return self._csp_destination_mac
        # PROTECTED REGION END #    //  LfaaTile.cspDestinationMac_read

    def write_cspDestinationMac(self, value):
        # PROTECTED REGION ID(LfaaTile.cspDestinationMac_write) ENABLED START #
        """Set the cspDestinationMac attribute."""
        self._csp_destination_mac = value
        # PROTECTED REGION END #    //  LfaaTile.cspDestinationMac_write

    def read_cspDestinationPort(self):
        # PROTECTED REGION ID(LfaaTile.cspDestinationPort_read) ENABLED START #
        """Return the cspDestinationPort attribute."""
        return self._csp_destination_port
        # PROTECTED REGION END #    //  LfaaTile.cspDestinationPort_read

    def write_cspDestinationPort(self, value):
        # PROTECTED REGION ID(LfaaTile.cspDestinationPort_write) ENABLED START #
        """Set the cspDestinationPort attribute."""
        self._csp_destination_port = value
        # PROTECTED REGION END #    //  LfaaTile.cspDestinationPort_writeself._csp_destination_mac

    def read_firmwareName(self):
        # PROTECTED REGION ID(LfaaTile.firmwareName_read) ENABLED START #
        """Return the firmwareName attribute."""
        return ""
        # PROTECTED REGION END #    //  LfaaTile.firmwareName_read

    def write_firmwareName(self, value):
        # PROTECTED REGION ID(LfaaTile.firmwareName_write) ENABLED START #
        """Set the firmwareName attribute."""
        pass
        # PROTECTED REGION END #    //  LfaaTile.firmwareName_write

    def read_firmwareVersion(self):
        # PROTECTED REGION ID(LfaaTile.firmwareVersion_read) ENABLED START #
        """Return the firmwareVersion attribute."""
        return ""
        # PROTECTED REGION END #    //  LfaaTile.firmwareVersion_read

    def write_firmwareVersion(self, value):
        # PROTECTED REGION ID(LfaaTile.firmwareVersion_write) ENABLED START #
        """Set the firmwareVersion attribute."""
        pass
        # PROTECTED REGION END #    //  LfaaTile.firmwareVersion_write

    def read_voltage(self):
        # PROTECTED REGION ID(LfaaTile.voltage_read) ENABLED START #
        """Return the voltage attribute."""
        return 0.0
        # PROTECTED REGION END #    //  LfaaTile.voltage_read

    def write_voltage(self, value):
        # PROTECTED REGION ID(LfaaTile.voltage_write) ENABLED START #
        """Set the voltage attribute."""
        pass
        # PROTECTED REGION END #    //  LfaaTile.voltage_write

    def read_current(self):
        # PROTECTED REGION ID(LfaaTile.current_read) ENABLED START #
        """Return the current attribute."""
        return 0.0
        # PROTECTED REGION END #    //  LfaaTile.current_read

    def write_current(self, value):
        # PROTECTED REGION ID(LfaaTile.current_write) ENABLED START #
        """Set the current attribute."""
        pass
        # PROTECTED REGION END #    //  LfaaTile.current_write

    def read_isProgrammed(self):
        # PROTECTED REGION ID(LfaaTile.isProgrammed_read) ENABLED START #
        """Return the isProgrammed attribute."""
        return self._programmed
        # PROTECTED REGION END #    //  LfaaTile.isProgrammed_read

    def read_board_temperature(self):
        # PROTECTED REGION ID(LfaaTile.board_temperature_read) ENABLED START #
        """Return the board_temperature attribute."""
        return 0.0
        # PROTECTED REGION END #    //  LfaaTile.board_temperature_read

    def read_fpga1_temperature(self):
        # PROTECTED REGION ID(LfaaTile.fpga1_temperature_read) ENABLED START #
        """Return the fpga1_temperature attribute."""
        return 0.0
        # PROTECTED REGION END #    //  LfaaTile.fpga1_temperature_read

    def read_fpga2_temperature(self):
        # PROTECTED REGION ID(LfaaTile.fpga2_temperature_read) ENABLED START #
        """Return the fpga2_temperature attribute."""
        return 0.0
        # PROTECTED REGION END #    //  LfaaTile.fpga2_temperature_read

    def read_stationId(self):
        # PROTECTED REGION ID(LfaaTile.stationId_read) ENABLED START #
        """Return the stationId attribute."""
        return self._station_id
        # PROTECTED REGION END #    //  LfaaTile.stationId_read

    def write_stationId(self, value):
        # PROTECTED REGION ID(LfaaTile.stationId_write) ENABLED START #
        """Set the stationId attribute."""
        self._station_id = value
        # PROTECTED REGION END #    //  LfaaTile.stationId_write

    def read_fpga1_time(self):
        # PROTECTED REGION ID(LfaaTile.fpga1_time_read) ENABLED START #
        """Return the fpga1_time attribute."""
        return 0.0
        # PROTECTED REGION END #    //  LfaaTile.fpga1_time_read

    def write_fpga1_time(self, value):
        # PROTECTED REGION ID(LfaaTile.fpga1_time_write) ENABLED START #
        """Set the fpga1_time attribute."""
        pass
        # PROTECTED REGION END #    //  LfaaTile.fpga1_time_write

    def read_fpga2_time(self):
        # PROTECTED REGION ID(LfaaTile.fpga2_time_read) ENABLED START #
        """Return the fpga2_time attribute."""
        return 0.0
        # PROTECTED REGION END #    //  LfaaTile.fpga2_time_read

    def write_fpga2_time(self, value):
        # PROTECTED REGION ID(LfaaTile.fpga2_time_write) ENABLED START #
        """Set the fpga2_time attribute."""
        pass
        # PROTECTED REGION END #    //  LfaaTile.fpga2_time_write

    def read_antennaIds(self):
        # PROTECTED REGION ID(LfaaTile.antennaIds_read) ENABLED START #
        """Return the antennaIds attribute."""
        return (0,)
        # PROTECTED REGION END #    //  LfaaTile.antennaIds_read

    def write_antennaIds(self, value):
        # PROTECTED REGION ID(LfaaTile.antennaIds_write) ENABLED START #
        """Set the antennaIds attribute."""
        pass
        # PROTECTED REGION END #    //  LfaaTile.antennaIds_write

    def read_fortyGbDestinationIps(self):
        # PROTECTED REGION ID(LfaaTile.fortyGbDestinationIps_read) ENABLED START #
        """Return the fortyGbDestinationIps attribute."""
        return ("",)
        # PROTECTED REGION END #    //  LfaaTile.fortyGbDestinationIps_read

    def read_fortyGbDestinationMacs(self):
        # PROTECTED REGION ID(LfaaTile.fortyGbDestinationMacs_read) ENABLED START #
        """Return the fortyGbDestinationMacs attribute."""
        return ("",)
        # PROTECTED REGION END #    //  LfaaTile.fortyGbDestinationMacs_read

    def read_fortyGbDestinationPorts(self):
        # PROTECTED REGION ID(LfaaTile.fortyGbDestinationPorts_read) ENABLED START #
        """Return the fortyGbDestinationPorts attribute."""
        return (0,)
        # PROTECTED REGION END #    //  LfaaTile.fortyGbDestinationPorts_read

    def write_fortyGbDestinationPorts(self, value):
        # PROTECTED REGION ID(LfaaTile.fortyGbDestinationPorts_write) ENABLED START #
        """Set the fortyGbDestinationPorts attribute."""
        pass
        # PROTECTED REGION END #    //  LfaaTile.fortyGbDestinationPorts_write

    def read_adcPower(self):
        # PROTECTED REGION ID(LfaaTile.adcPower_read) ENABLED START #
        """Return the adcPower attribute."""
        return (0.0,)
        # PROTECTED REGION END #    //  LfaaTile.adcPower_read

    def write_adcPower(self, value):
        # PROTECTED REGION ID(LfaaTile.adcPower_write) ENABLED START #
        """Set the adcPower attribute."""
        pass
        # PROTECTED REGION END #    //  LfaaTile.adcPower_write
    ...
    @DebugIt()
    def Initialise(self):
        # PROTECTED REGION ID(LfaaTile.Initialise) ENABLED START #
        """
        ...
        """
        pass
        # PROTECTED REGION END #    //  LfaaTile.Initialise

    @command(dtype_in="DevBoolean", doc_in="Initialise")
    @DebugIt()
    def Connect(self, argin):
        # PROTECTED REGION ID(LfaaTile.Connect) ENABLED START #
        """
        ...
        if argin and self._programmed:
            self.Initialise()
        # PROTECTED REGION END #    //  LfaaTile.Connect

    @command()
    @DebugIt()
    def Disconnect(self):
        # PROTECTED REGION ID(LfaaTile.Disconnect) ENABLED START #
        """
        ...
        """
        pass
        # PROTECTED REGION END #    //  LfaaTile.Disconnect

    @command(dtype_in="DevString", doc_in="bitfile location")
    @DebugIt()
    def DownloadFirmware(self, argin):
        # PROTECTED REGION ID(LfaaTile.DownloadFirmware) ENABLED START #
        """
        ...
        """
        pass
        # PROTECTED REGION END #    //  LfaaTile.DownloadFirmware

    @command(dtype_in="DevString", doc_in="bitfile location")
    @DebugIt()
    def ProgramCPLD(self, argin):
        # PROTECTED REGION ID(LfaaTile.ProgramCPLD) ENABLED START #
        """
        ...
        """
        pass
        # PROTECTED REGION END #    //  LfaaTile.ProgramCPLD

    @command()
    @DebugIt()
    def WaitPPSEvent(self):
        # PROTECTED REGION ID(LfaaTile.WaitPPSEvent) ENABLED START #
        """
        ...
        """
        pass
        # PROTECTED REGION END #    //  LfaaTile.WaitPPSEvent

    @command(dtype_out="DevEnum")
    @DebugIt()
    def GetRegisterList(self):
        # PROTECTED REGION ID(LfaaTile.GetRegisterList) ENABLED START #
        """
        ...
        """
        pass
        # PROTECTED REGION END #    //  LfaaTile.GetRegisterList
    ...
    def ReadRegister(self, argin):
        # PROTECTED REGION ID(LfaaTile.ReadRegister) ENABLED START #
        """
    ...
    def WriteRegister(self, argin):
        ...
        """
        pass
        # PROTECTED REGION END #    //  LfaaTile.WriteRegister
    ...
    def ReadAddress(self, argin):
        # PROTECTED REGION ID(LfaaTile.ReadAddress) ENABLED START #
        """
        ...
        """
        return [0]
        # PROTECTED REGION END #    //  LfaaTile.ReadAddress

    @command(dtype_in="DevVarULongArray", doc_in="address, values")
    @DebugIt()
    def WriteAddress(self, argin):
        # PROTECTED REGION ID(LfaaTile.WriteAddress) ENABLED START #
        """
        ...
        """
        pass
        # PROTECTED REGION END #    //  LfaaTile.WriteAddress
    ...
    def Configure40GCore(self, argin):
        # PROTECTED REGION ID(LfaaTile.Configure40GCore) ENABLED START #
        """
        ...
        # PROTECTED REGION END #    //  LfaaTile.Configure40GCore
    ...
    def Get40GCoreConfiguration(self, argin):
        # PROTECTED REGION ID(LfaaTile.Get40GCoreConfiguration) ENABLED START #
        """
    ...
    def SetLMCDownload(self, argin):
        # PROTECTED REGION ID(LfaaTile.SetLMCDownload) ENABLED START #
        """
        ...
        """
        pass
        # PROTECTED REGION END #    //  LfaaTile.SetLMCDownload

    @command(dtype_in="DevVarLongArray", doc_in="truncation array")
    @DebugIt()
    def SetChanneliserTruncation(self, argin):
        # PROTECTED REGION ID(LfaaTile.SetChanneliserTruncation) ENABLED START #
        """
        ...
        """
        pass
        # PROTECTED REGION END #    //  LfaaTile.SetChanneliserTruncation

    @command(dtype_in="DevVarLongArray", doc_in="region_array")
    @DebugIt()
    def SetBeamFormerRegions(self, argin):
        # PROTECTED REGION ID(LfaaTile.SetBeamFormerRegions) ENABLED START #
        """
        ...
        """
        pass
        # PROTECTED REGION END #    //  LfaaTile.SetBeamFormerRegions
    ...
    def ConfigureStationBeamformer(self, argin):
        # PROTECTED REGION ID(LfaaTile.ConfigureStationBeamformer) ENABLED START #
        """
        ...
        """
        pass
        # PROTECTED REGION END #    //  LfaaTile.ConfigureStationBeamformer

    @command(dtype_in="DevEncoded", doc_in="antenna, calibration_coefficients")
    @DebugIt()
    def LoadCalibrationCoefficients(self, argin):
        # PROTECTED REGION ID(LfaaTile.LoadCalibrationCoefficients) ENABLED START #
        """
        ...
        """
        pass
        # PROTECTED REGION END #    //  LfaaTile.LoadCalibrationCoefficients

    @command(dtype_in="DevVarDoubleArray", doc_in="angle_coefficients")
    @DebugIt()
    def LoadBeamAngle(self, argin):
        # PROTECTED REGION ID(LfaaTile.LoadBeamAngle) ENABLED START #
        """
        ...
        """
        pass
        # PROTECTED REGION END #    //  LfaaTile.LoadBeamAngle

    @command(dtype_in="DevVarDoubleArray", doc_in="tapering coefficients")
    @DebugIt()
    def LoadAntennaTapering(self, argin):
        # PROTECTED REGION ID(LfaaTile.LoadAntennaTapering) ENABLED START #
        """
        ...
        """
        pass
        # PROTECTED REGION END #    //  LfaaTile.LoadAntennaTapering

    @command(dtype_in="DevDouble", doc_in="switch time")
    @DebugIt()
    def SwitchCalibrationBank(self, argin):
        # PROTECTED REGION ID(LfaaTile.SwitchCalibrationBank) ENABLED START #
        """
        ...
        """
        pass
        # PROTECTED REGION END #    //  LfaaTile.SwitchCalibrationBank

    @command(dtype_in="DevVarLongArray", doc_in="delay_array, beam_index")
    @DebugIt()
    def SetPointingDelay(self, argin):
        # PROTECTED REGION ID(LfaaTile.SetPointingDelay) ENABLED START #
        """
        ...
        """
        pass
        # PROTECTED REGION END #    //  LfaaTile.SetPointingDelay

    @command(dtype_in="DevDouble", doc_in="load_time")
    @DebugIt()
    def LoadPointingDelay(self, argin):
        # PROTECTED REGION ID(LfaaTile.LoadPointingDelay) ENABLED START #
        """
        ...
        """
        pass
        # PROTECTED REGION END #    //  LfaaTile.LoadPointingDelay

    @command(dtype_in="DevDouble", doc_in="start_time")
    @DebugIt()
    def StartBeamformer(self, argin):
        # PROTECTED REGION ID(LfaaTile.StartBeamformer) ENABLED START #
        """
        ...
        """
        pass
        # PROTECTED REGION END #    //  LfaaTile.StartBeamformer

    @command()
    @DebugIt()
    def StopBeamformer(self):
        # PROTECTED REGION ID(LfaaTile.StopBeamformer) ENABLED START #
        """
        Stop the beamformer
        ...
        """
        pass
        # PROTECTED REGION END #    //  LfaaTile.StopBeamformer

    @command(dtype_in="DevDouble", doc_in="Integration time")
    @DebugIt()
    def ConfigureIntegratedChannelData(self, argin):
        # PROTECTED REGION ID(LfaaTile.ConfigureIntegratedChannelData) ENABLED START #
        """
        ...
        """
        pass
        # PROTECTED REGION END #    //  LfaaTile.ConfigureIntegratedChannelData

    @command(dtype_in="DevDouble", doc_in="Integration time")
    @DebugIt()
    def ConfigureIntegratedBeamData(self, argin):
        # PROTECTED REGION ID(LfaaTile.ConfigureIntegratedBeamData) ENABLED START #
        """
        ...
        """
        pass
        # PROTECTED REGION END #    //  LfaaTile.ConfigureIntegratedBeamData

    @command()
    @DebugIt()
    def SendRawData(self):
        # PROTECTED REGION ID(LfaaTile.SendRawData) ENABLED START #
        """
        ...
        """
        pass
        # PROTECTED REGION END #    //  LfaaTile.SendRawData

    @command(dtype_in="DevLong", doc_in="number of samples")
    @DebugIt()
    def SendChannelisedData(self, argin):
        # PROTECTED REGION ID(LfaaTile.SendChannelisedData) ENABLED START #
        """
        ...
        """
        pass
        # PROTECTED REGION END #    //  LfaaTile.SendChannelisedData

    @command(dtype_in="DevLong", doc_in="Channel")
    @DebugIt()
    def SendChannelisedDataContinuous(self, argin):
        # PROTECTED REGION ID(LfaaTile.SendChannelisedDataContinuous) ENABLED START #
        """
        ...
        """
        pass
        # PROTECTED REGION END #    //  LfaaTile.SendChannelisedDataContinuous

    @command()
    @DebugIt()
    def SendBeamData(self):
        # PROTECTED REGION ID(LfaaTile.SendBeamData) ENABLED START #
        """
        ...
        """
        pass
        # PROTECTED REGION END #    //  LfaaTile.SendBeamData

    @command()
    @DebugIt()
    def StopDataTransmission(self):
        # PROTECTED REGION ID(LfaaTile.StopDataTransmission) ENABLED START #
        """
        ...
        """
        pass
        # PROTECTED REGION END #    //  LfaaTile.StopDataTransmission
...
def main(args=None, **kwargs):
    """Main function of the LfaaTile module."""
    # PROTECTED REGION ID(LfaaTile.main) ENABLED START #
    return run((LfaaTile,), args=args, **kwargs)
    # PROTECTED REGION END #    //  LfaaTile.main
