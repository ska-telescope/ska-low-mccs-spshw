    ...
    **Properties:**
    ...
    class AddMemberCommand(ResponseCommand):
        ...
        def do(self, argin):
            ...
            :py:meth:`ska_low_mccs.group_device.MccsGroupDevice.AddMember` command
    ...
    class RemoveMemberCommand(ResponseCommand):
        ...
        def do(self, argin):
            """
            Stateless do-hook for the
            :py:meth:`ska_low_mccs.group_device.MccsGroupDevice.RemoveMember` command
    ...
    class RunCommand(ResponseCommand):
        ...
        def do(self, argin):
            """
            Stateless do-hook for the
            :py:meth:`ska_low_mccs.group_device.MccsGroupDevice.Run` command
