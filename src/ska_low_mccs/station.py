...
# additional imports
from ska_tango_base import DeviceStateModel, SKABaseDevice, SKAObsDevice
...
class MccsStation(SKAObsDevice):
    ...
    **Properties:**
    ...
    class InitCommand(SKAObsDevice.InitCommand):
        ...
        def do(self: MccsStation.InitCommand) -> tuple[ResultCode, str]:
            """
        ...
        def _initialise_connections(
            self: MccsStation.InitCommand, device: SKABaseDevice
        ) -> None:
            """
        ...
        def interrupt(self: MccsStation.InitCommand) -> bool:
            """
    ...
    def always_executed_hook(self: MccsStation) -> None:
        """Method always executed before any TANGO command is executed."""

    def delete_device(self: MccsStation) -> None:
        """
    ...
    def aHeartBeat(self: MccsStation) -> int:
        """
    ...
    @attribute(dtype="DevLong", format="%i", max_value=16, min_value=0)
    ...
    @attribute(dtype="float", label="refLongitude")
    ...
    @attribute(dtype="float", label="refLatitude")
    ...
    @attribute(dtype="float", label="refHeight", unit="meters")
    ...
    @attribute(dtype=("DevString",), max_dim_x=8, format="%s")
    ...
    @attribute(dtype=("DevFloat",), max_dim_x=2)
    ...
    def delayCentre(self: MccsStation, value: list[float]):
        """
    ...
    @attribute(dtype=("DevFloat",), max_dim_x=512)
    ...
    def aPoolStats(self: MccsStation) -> str:
        """
    ...
    @attribute(dtype="DevString")
    def aQueueDebug(self: MccsStation) -> str:
        """
    ...
    def aQueueDebug(self: MccsStation, debug_string: str) -> None:
        """
    ...
    def commandProgress(self: MccsStation) -> int:
        """
    ...
    def _store_callback_send_message(
        self: MccsStation, command: str, json_args: str
    ...
    @DebugIt()
    def On(self: MccsStation, json_args: str) -> DevVarLongStringArrayType:
        """
    ...
    class OnCommand(SKABaseDevice.OnCommand):
        ...
        def do(self: MccsStation.OnCommand, argin: str) -> tuple[ResultCode, str]:
            """
            ...
            if device._cmd_respond_to_fqdn and device._cmd_callback:
                ...
                if device_pool.invoke_command_with_callback(
                    command_name="On", fqdn=fqdn, callback="Callback"
                ):
    ...
    @command(dtype_in="DevString", dtype_out="DevVarLongStringArray")
    @DebugIt()
    def Callback(self: MccsStation, json_args: str) -> DevVarLongStringArrayType:
        """
        Callback method.
    ...
    class CallbackCommand(ResponseCommand):
        ...
        def do(self: MccsStation.CallbackCommand, argin: str) -> tuple[ResultCode, str]:
            """
    ...
    @command(dtype_in="DevString", dtype_out="DevVarLongStringArray")
    @DebugIt()
    def Off(self: MccsStation, json_args: str) -> DevVarLongStringArrayType:
        """
    ...
    class OffCommand(SKABaseDevice.OffCommand):
        ...
        def do(self: MccsStation.OffCommand, argin: str) -> tuple[ResultCode, str]:
            """
            Stateless hook implementing the functionality of the (inherited)
            ...
            if device._cmd_respond_to_fqdn and device._cmd_callback:
                ...
                if device_pool.invoke_command_with_callback(
                    command_name="Off", fqdn=fqdn, callback="Callback"
                ):
                    return (ResultCode.OK, self.QUEUED_MESSAGE)
                else:
                    self.logger.error(self.QUEUE_FAIL_MESSAGE)
    ...
    class StandbyCommand(SKABaseDevice.StandbyCommand):
        ...
        def do(self: MccsStation.StandbyCommand) -> tuple[ResultCode, str]:
            """
            Stateless hook implementing the functionality of the (inherited)
    ...
    class DisableCommand(SKABaseDevice.DisableCommand):
        ...
        def do(self: MccsStation.DisableCommand) -> tuple[ResultCode, str]:
            """
            Stateless hook implementing the functionality of the (inherited)
    ...
    class InitialSetupCommand(ResponseCommand):
        ...
        def do(self: MccsStation.InitialSetupCommand) -> tuple[ResultCode, str]:
            """
            Stateless hook implementing the functionality of the
    ...
    def InitialSetup(self: MccsStation) -> DevVarLongStringArrayType:
        """
