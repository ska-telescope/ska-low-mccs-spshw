...
# Additional import
from ska_tango_base import DeviceStateModel, SKABaseDevice
...
class TransientBufferManager:
    ...
    def __init__(self: TransientBufferManager) -> None:
        """Construct a new TransientBufferManager."""
        pass

    def send(self: TransientBufferManager, segment_spec: str) -> None:
        """
...
class MccsSubarray(SKASubarray):
    ...
    class InitCommand(SKASubarray.InitCommand):
        ...
        def __init__(
            ...
            self._message_queue: Optional[MccsSubarrayQueue] = None
            self._qdebuglock = threading.Lock()

        def do(self: MccsSubarray.InitCommand) -> Tuple[ResultCode, str]:
            """
            ...
            device._station_beam_fqdns: List[str] = list()  # type: ignore[misc]
            device._station_fqdns: List[str] = list()  # type: ignore[misc]
            device._subarray_beam_fqdns: List[str] = list()  # type: ignore[misc]
        ...
        def _initialise_connections(
            self: MccsSubarray.InitCommand, device: SKABaseDevice
        ) -> None:
            """
    ...
    def always_executed_hook(self: MccsSubarray) -> None:
        """Method always executed before any TANGO command is executed."""

    def delete_device(self: MccsSubarray) -> None:
        """
    ...
    def notify_listener(
        ...
        :param status: Status message
        """
        self._message_queue._notify_listener(result_code, message_uid, status)  # type: ignore[attr-defined]
    ...
    def scanId(self: MccsSubarray, scan_id: int) -> None:
        """
    ...
    class OnCommand(SKASubarray.OnCommand):
        ...
        def do(self: MccsSubarray.OnCommand, argin: str) -> Tuple[ResultCode, str]:
            """
    ...
    class OffCommand(SKASubarray.OffCommand):
        ...
        def do(self: MccsSubarray.OffCommand) -> Tuple[ResultCode, str]:
            """
            Stateless hook implementing the functionality of the (inherited)
    ...
    class AssignResourcesCommand(SKASubarray.AssignResourcesCommand):
        ...
        def succeeded(self: MccsSubarray.AssignResourcesCommand) -> None:
    ...
    class ReleaseResourcesCommand(SKASubarray.ReleaseResourcesCommand):
        ...
        def succeeded(self: MccsSubarray.ReleaseResourcesCommand) -> None:
            """Action to take on successful completion of a resourcing command."""
    ...
    class ReleaseAllResourcesCommand(SKASubarray.ReleaseAllResourcesCommand):
        ...
        def do(self: MccsSubarray.ReleaseAllResourcesCommand) -> Tuple[ResultCode, str]:
            """
            Stateless hook implementing the functionality of the
            (inherited)
        ...
        def succeeded(self: MccsSubarray.ReleaseAllResourcesCommand) -> None:
            """Action to take on successful completion of a resourcing command."""
            action = "resourcing_succeeded_some_resources"
            self.state_model.perform_action(action)
    ...
    class ConfigureCommand(SKASubarray.ConfigureCommand):
        ...
        def check_allowed(self: MccsSubarray.ConfigureCommand) -> bool:
            """
    ...
    class ScanCommand(SKASubarray.ScanCommand):
        ...
        def do(self: MccsSubarray.ScanCommand, argin: str) -> Tuple[ResultCode, str]:
            """
            Stateless hook implementing the functionality of the (inherited)
    ...
    class EndScanCommand(SKASubarray.EndScanCommand):
        ...
        def do(self: MccsSubarray.EndScanCommand) -> Tuple[ResultCode, str]:
            """
            Stateless hook implementing the functionality of the (inherited)
    ...
    class EndCommand(SKASubarray.EndCommand):
        ...
        def do(self: MccsSubarray.EndCommand) -> Tuple[ResultCode, str]:
            """
            Stateless hook implementing the functionality of the (inherited)
    ...
    class AbortCommand(SKASubarray.AbortCommand):
        ...
        def do(self: MccsSubarray.AbortCommand) -> Tuple[ResultCode, str]:
            """
            Stateless hook implementing the functionality of the (inherited)
    ...
    @DebugIt()
    def Abort(self: MccsSubarray) -> DevVarLongStringArrayType:
        """
    ...
    class ObsResetCommand(SKASubarray.ObsResetCommand):
        ...
        def do(self: MccsSubarray.ObsResetCommand) -> Tuple[ResultCode, str]:
            """
            Stateless hook implementing the functionality of the (inherited)
    ...
    class RestartCommand(SKASubarray.RestartCommand):
        ...
        def do(self: MccsSubarray.RestartCommand) -> Tuple[ResultCode, str]:
            """
            Stateless hook implementing the functionality of the (inherited)
