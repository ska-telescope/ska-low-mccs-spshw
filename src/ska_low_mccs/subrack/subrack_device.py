...
class MccsSubrack(SKABaseDevice):
    ...
    def backplaneTemperatures(self):
        ...
        :rtype: tuple(float)
        """
        return tuple(self.component_manager.backplane_temperatures)
    ...
    def boardTemperatures(self):
        ...
        :rtype: tuple(float)
        """
        return tuple(self.component_manager.board_temperatures)
    ...
    def subrackFanSpeeds(self):
        ...
        :rtype: tuple(float)
        """
        return tuple(self.component_manager.subrack_fan_speeds)
    ...
    def subrackFanSpeedsPercent(self):
        ...
        :rtype: list(float)
        """
        return tuple(self.component_manager.subrack_fan_speeds_percent)
    ...
    def tpmPresent(self):
        ...
        :rtype: tuple(bool)
        """
        return tuple(self.component_manager.tpm_present)
    ...
    def tpmSupplyFault(self):
        ...
        :rtype: tuple(int)
        """
        return tuple(self.component_manager.tpm_supply_fault)
    ...
    def tpmTemperatures(self):
        ...
        :rtype: tuple(float)
        """
        return tuple(self.component_manager.tpm_temperatures)
    ...
    def tpmPowers(self):
        ...
        :rtype: tuple(float)
        """
        return tuple(self.component_manager.tpm_powers)
    ...
    def tpmVoltages(self):
        ...
        :rtype: tuple(float)
        """
        return tuple(self.component_manager.tpm_voltages)
    ...
    def powerSupplyFanSpeeds(self):
        ...
        :rtype: tuple(float)
        """
        return tuple(self.component_manager.power_supply_fan_speeds)
    ...
    def powerSupplyCurrents(self):
        ...
        :rtype: tuple(float)
        """
        return tuple(self.component_manager.power_supply_currents)
    ...
    def powerSupplyPowers(self):
        ...
        :rtype: tuple(float)
        """
        return tuple(self.component_manager.power_supply_powers)
    ...
    def powerSupplyVoltages(self):
        ...
        :rtype: tuple(float)
        """
        return tuple(self.component_manager.power_supply_voltages)
