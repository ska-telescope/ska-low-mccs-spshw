...
class SpsStation(SKAObsDevice):
    ...
    def component_state_changed_callback(
        ...
        changes.
        :TODO: Power state changes are generated by Component Manager or
            controlled device proxies, but actually set in CM using calls from
            this callback. The information flow should be CM->device,
            not a loop. 
