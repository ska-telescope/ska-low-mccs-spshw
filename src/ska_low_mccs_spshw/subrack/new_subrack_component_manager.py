...
__all__ = ["NewSubrackComponentManager"]


class NewSubrackComponentManager(ComponentManagerWithUpstreamPowerSupply):
    """A component manager for an subrack (simulator or driver) and its power supply."""

    def __init__(  # pylint: disable=too-many-arguments
        self: NewSubrackComponentManager,
        subrack_ip: str,
        subrack_port: int,
    ...
    def turn_off_tpms(
        self: NewSubrackComponentManager, task_callback: Optional[Callable] = None
    ) -> tuple[TaskStatus, str]:
        """
        Turn all TPMs off.
