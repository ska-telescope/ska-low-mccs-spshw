...
class NewSubrackDevice(SKABaseDevice):  # pylint: disable=too-many-public-methods
    ...
    def __init__(self: NewSubrackDevice, *args: Any, **kwargs: Any) -> None:
        """
    ...
    class InitCommand(DeviceInitCommand):
        ...
        def do(
            self: NewSubrackDevice.InitCommand, *args: Any, **kwargs: Any
        ) -> tuple[ResultCode, str]:
            """
            Initialise the attributes of this NewSubrackDevice.
            ...
            for attribute_name in NewSubrackDevice._ATTRIBUTE_MAP.values():
                self._device.set_change_event(attribute_name, True)

            message = "NewSubrackDevice init complete."
    ...
    def PowerOnTpm(  # pylint: disable=invalid-name
        self: NewSubrackDevice, argin: int
    ...
    def SetSubrackFanSpeed(  # pylint: disable=invalid-name
        self: NewSubrackDevice, argin: str
    ) -> tuple[list[ResultCode], list[Optional[str]]]:
        """
    ...
    def tpmCount(self: NewSubrackDevice, attr: tango.Attribute) -> None:
        """
    ...
    def tpmPresent(  # pylint: disable=invalid-name
        self: NewSubrackDevice, attr: tango.Attribute
    ) -> None:
        """
    ...
    def _get_tpm_power_state(
        self: NewSubrackDevice, attr: tango.Attribute, tpm_number: int
    ) -> None:
    ...
    def backplaneTemperatures(self: NewSubrackDevice, attr: tango.Attribute) -> None:
        """
    ...
    def boardTemperatures(self: NewSubrackDevice, attr: tango.Attribute) -> None:
        """
    ...
    def boardCurrent(self: NewSubrackDevice, attr: tango.Attribute) -> None:
        """
    ...
    def powerSupplyCurrents(self: NewSubrackDevice, attr: tango.Attribute) -> None:
        """
    ...
    def powerSupplyFanSpeeds(self: NewSubrackDevice, attr: tango.Attribute) -> None:
        """
    ...
    def powerSupplyPowers(self: NewSubrackDevice, attr: tango.Attribute) -> None:
        """
    ...
    def powerSupplyVoltages(self: NewSubrackDevice, attr: tango.Attribute) -> None:
        """
    ...
    def subrackFanSpeeds(self: NewSubrackDevice, attr: tango.Attribute) -> None:
        """
    ...
    def subrackFanSpeedsPercent(self: NewSubrackDevice, attr: tango.Attribute) -> None:
        """
    ...
    def subrackFanModes(self: NewSubrackDevice, attr: tango.Attribute) -> None:
        """
    ...
    def tpmCurrents(self: NewSubrackDevice, attr: tango.Attribute) -> None:
        """
    ...
    def tpmPowers(self: NewSubrackDevice, attr: tango.Attribute) -> None:
        """
    ...
    def tpmTemperatures(self: NewSubrackDevice, attr: tango.Attribute) -> None:
        """
    ...
    def tpmVoltages(self: NewSubrackDevice, attr: tango.Attribute) -> None:
        """
    ...
    def _get_hardware_attribute(
        self: NewSubrackDevice, name: str, attr: tango.Attribute
    ) -> None:
    ...
    def _communication_state_changed(
        self: NewSubrackDevice, communication_state: CommunicationStatus
    ) -> None:
        self.logger.debug(
    ...
    def _update_tpm_present(self: NewSubrackDevice, tpm_present: list[bool]) -> None:
    ...
    def _update_tpm_on_off(self: NewSubrackDevice, tpm_on_off: list[bool]) -> None:
        for tpm_number in range(1, SubrackData.TPM_BAY_COUNT + 1):
            power_state = (
...
def main(args: Any = None, **kwargs: Any) -> int:
    """
    Launch a `NewSubrackDevice` Tango device server instance.
    ...
    """
    return run((NewSubrackDevice,), args=args, **kwargs)
