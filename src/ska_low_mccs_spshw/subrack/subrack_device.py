...
class MccsSubrack(MccsBaseDevice[SubrackComponentManager]):
    ...
    SubrackPort = device_property(dtype="DevShort", default_value=8081)
    UpdateRate = device_property(dtype="DevFloat", default_value=15.0)
    ...
    @attribute(dtype="DevDouble", abs_change=0.1, label="internalVoltagesV_1V1")
    ...
    @attribute(dtype="DevDouble", abs_change=0.1, label="internalVoltagesV_1V5")
    ...
    @attribute(dtype="DevDouble", abs_change=0.1, label="internalVoltagesV_2V5")
    ...
    @attribute(dtype="DevDouble", abs_change=0.1, label="internalVoltages_2V8")
    ...
    @attribute(dtype="DevDouble", abs_change=0.1, label="internalVoltages_3V")
    ...
    @attribute(dtype="DevDouble", abs_change=0.1, label="internalVoltages_3V3")
    ...
    @attribute(dtype="DevDouble", abs_change=0.1, label="internalVoltages_5V")
    ...
    @attribute(dtype="DevDouble", abs_change=0.1, label="internalVoltages_ARM")
    ...
    @attribute(dtype="DevDouble", abs_change=0.1, label="internalVoltages_CORE")
    ...
    @attribute(dtype="DevDouble", abs_change=0.1, label="internalVoltages_DDR")
    ...
    @attribute(dtype="DevDouble", abs_change=0.1, label="internalVoltages_POWERIN")
    ...
    @attribute(dtype="DevDouble", abs_change=0.1, label="internalVoltages_SOC")
