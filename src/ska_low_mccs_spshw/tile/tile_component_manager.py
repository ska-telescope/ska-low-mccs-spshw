...
class TileComponentManager(MccsBaseComponentManager, PollingComponentManager):
    ...
    def get_request(  # type: ignore[override]
        ...
        match request_spec:
            ...
            case ("TILE_BEAMFORMER_FRAME", None):
                request = TileRequest(
    ...
    def poll(self: TileComponentManager, poll_request: TileRequest) -> TileResponse:
        ...
        if self.command_task_callback is not None:
    ...
    def get_beamformer_table(self: TileComponentManager) -> list[list[int]]:
        ...
        It interfaces with low down methods.
        ...
        return copy.deepcopy(
            self.tile.tpm.station_beamf[0].get_channel_table()[0 : self._nof_blocks]
        )
