...
def mock_device_proxies(mocker, mock_factory, initial_mocks):
    """
    Fixture that sets ups :py:class:`ska_low_mccs.device_proxy.MccsDeviceProxy` to
...
def device_under_test(device_context, device_to_load):
    """
    Creates and returns a :py:class:`ska_low_mccs.device_proxy.MccsDeviceProxy` to
    ...
    :returns: a :py:class:`ska_low_mccs.device_proxy.MccsDeviceProxy` under a
        :py:class:`tango.test_context.MultiDeviceTestContext`
