...
class TestMccsController(HelperClass):
    ...
    def test_On(
        ...
        result_code, message_uid = command_helper.device_command_with_callback(
    ...
    class TestAllocateRelease(HelperClass):
        ...
        and
        :py:meth:`~ska_low_mccs.controller.controller_device.MccsController.Release`
        commands.
        """
        ...
        def setup_allocate_test(
            ...
            :param controller: fixture that provides a
                ...
                in a
                :py:class:`tango.test_context.DeviceTestContext`.
            :type controller: :py:class:`tango.DeviceProxy`
            :param mock_event_callback: fixture that provides a mock
                instance with callback support methods
            ...
            call_with_json(
                controller.simulateAdminModeChange,
        ...
        def test_Allocate_Subarray_Failures(
            self,
            device_under_test,
            mock_event_callback,
            logger,
    ...
    def test_healthState(self, device_under_test, mock_event_callback):
        ...
        assert device_under_test.healthState == HealthState.UNKNOWN
        mock_event_callback.assert_not_called()
        # TODO: device_under_test has hanged from subarray to controller
        # not sure if this should work. Added not called for now.
        #         mock_event_callback.check_event_data(
        #             name="healthState", result=device_under_test.healthState
        #         )
...
class TestInitCommand:
    ...
    :py:class:`~ska_low_mccs.controller.controller_device.MccsController`'s
    :py:class:`~ska_low_mccs.controller.controller_device.MccsController.InitCommand`.
    """
