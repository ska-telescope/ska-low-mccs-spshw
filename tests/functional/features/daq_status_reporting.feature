...
Feature: Daq Status Reporting
    ...
    Scenario Outline: Consumers Starting Up
        ...
        Examples: tbl_consumers_up
            ...
            #       ---------------------------------
            | 'RAW_DATA'                | ral-software |
            | 'CHANNEL_DATA'            | ral-software |
            | 'BEAM_DATA'               | ral-software |
            | 'CONTINUOUS_CHANNEL_DATA' | ral-software |
            | 'INTEGRATED_BEAM_DATA'    | ral-software |
            | 'STATION_BEAM_DATA'       | ral-software |
            | 'ANTENNA_BUFFER'          | ral-software |
