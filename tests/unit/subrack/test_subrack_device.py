...
def test_off_on(
    ...
    subrack_lrc_manager.run_command_with_checks(
...
def test_monitoring_and_control(
    ...
    * make the simulator report new values
    ...
    if power_state == PowerState.OFF:
        ...
        subrack_lrc_manager.run_command_with_checks(
            "PowerOnTpm", tpm_to_power, ResultCode.QUEUED
        )
        subrack_lrc_manager.assert_command_queued()
        subrack_lrc_manager.assert_command_in_progress()
...
# )
# # pylint: disable=too-many-arguments
# def test_scaled_fan_speed(
#     subrack_device: MccsSubrack,
#     subrack_simulator: SubrackSimulator,
#     change_event_callbacks: MockTangoEventCallbackGroup,
#     fan_rpm_read: float,
#     fan_pwm_duty: float,
#     scaled_fan_rpm: float,
#     expected_result: bool,
# ) -> None:
#     """
#     Test the result of the scaled fan speed attribute.

#     :param subrack_device: the subrack Tango device under test.
#     :param subrack_simulator: the simulator for the backend
#     :param change_event_callbacks: dictionary of Tango change event
#         callbacks with asynchrony support.
#     :param fan_rpm_read: value to set the rpm
#     :param fan_pwm_duty: value to set the pwm duty to
#     :param scaled_fan_rpm: expected scaled rpm
#     :param expected_result: if the values pass or not
#     """
#     subrack_simulator.simulate_attribute(
#         "subrack_fan_speeds_percent", [fan_rpm_read] * 4
#     )
#     subrack_simulator.simulate_attribute(
#         "subrack_fan_speeds_percent", [fan_rpm_read] * 4
#     )
