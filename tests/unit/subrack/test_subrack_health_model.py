            ...
            pytest.param(
                {
                    ...
                    "tpm_voltages": [],
                    "power_supply_voltages": [],
                    "power_supply_powers": [300.0, 300.0],
                    "tpm_power_states": [
                        PowerState.ON,
                        PowerState.ON,
                        PowerState.ON,
            ...
            pytest.param(
                {
                    ...
                    "tpm_voltages": [],
                    "power_supply_voltages": [],
                    "power_supply_powers": [900.0, 300.0],
                    "tpm_power_states": [
                        PowerState.ON,
                        PowerState.ON,
                        PowerState.ON,
                ...
                HealthState.DEGRADED,
                "Health is DEGRADED.",  # TODO: Confirm final message.
            ...
            pytest.param(
                {
                    ...
                    "tpm_voltages": [],
                    "power_supply_voltages": [],
                    "power_supply_powers": [300.0, 900.0],
                    "tpm_power_states": [
                        PowerState.ON,
                        PowerState.ON,
                        PowerState.ON,
            ...
            pytest.param(
                {
                    ...
                    "tpm_voltages": [],
                    "power_supply_voltages": [],
                    "power_supply_powers": [1000.0, 300.0],
                    "tpm_power_states": [
                        PowerState.ON,
                        PowerState.ON,
                        PowerState.ON,
                ...
                HealthState.FAILED,
                "Health is FAILED.",  # TODO: Confirm final message.
            ...
            pytest.param(
                {
                    ...
                    "tpm_voltages": [],
                    "power_supply_voltages": [],
                    "power_supply_powers": [300.0, 1000.0],
                    "tpm_power_states": [
                        PowerState.ON,
                        PowerState.ON,
                        PowerState.ON,
            ...
            pytest.param(
                {
                    ...
                    "board_currents": [],
                    "tpm_currents": [],
                    "power_supply_currents": [0.0, 500.0 / 229.6],
                    "tpm_voltages": [],
                    "power_supply_voltages": [0.0, 229.6],
                    "power_supply_powers": [0.0, 500.0],
                    "tpm_power_states": [
                        PowerState.ON,
                        PowerState.ON,
                        PowerState.ON,
            ...
            pytest.param(
                {
                    ...
                    "board_currents": [],
                    "tpm_currents": [],
                    "power_supply_currents": [500.0 / 229.6, 0.0],
                    "tpm_voltages": [],
                    "power_supply_voltages": [229.6, 0.0],
                    "power_supply_powers": [500.0, 0.0],
                    "tpm_power_states": [
                        PowerState.ON,
                        PowerState.ON,
                        PowerState.ON,
