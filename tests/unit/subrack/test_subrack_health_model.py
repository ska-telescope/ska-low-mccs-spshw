...
NUMBER_OF_SUBRACK_STATE_MONITOR_POINTS = 16
    ...
    @pytest.mark.parametrize(
        ...
        [
            pytest.param(
                {
                    ...
                    "subrack_scaled_fan_speeds": [6500, 6500],
                    "board_currents": [16.0],
                    "tpm_currents": [4.0, 4.0, 4.0, 4.0, 4.0],
                    "power_supply_currents": [8.0, 8.0],
                    "tpm_voltages": [5.0, 5.0, 5.0, 5.0],
                    "power_supply_voltages": [12.0, 12.0],
                    "power_supply_voltages_in": [230.0, 230.0],
                    "power_supply_present": [True, True],
                    "power_supply_loads": [0.25, 0.25],
                    "tpm_power_states": [
                        PowerState.ON,
                        PowerState.ON,
                        PowerState.ON,
            ...
            pytest.param(
                ...
                HealthState.OK,
                "Health is OK.",
                id="Both PSUs below 50% load. Health OK.",
            ),
            pytest.param(
                {
                    "board_temps": [],
                ...
                HealthState.DEGRADED,
                "PSU1's load is over 0.5, ",
                id="PSU 1 over 50% load. Health DEGRADED.",
            ),
            pytest.param(
                {
                    "board_temps": [],
                ...
                HealthState.DEGRADED,
                "PSU2's load is over 0.5, ",
                id="PSU 2 over 50% load. Health DEGRADED.",
            ),
            pytest.param(
                {
                    "board_temps": [],
                ...
                HealthState.DEGRADED,
                "PSU1's load is over 0.5, PSU2's load is over 0.5, ",
                id="Both PSU over 50% load. Health DEGRADED.",
            ),
            pytest.param(
                {
                    "board_temps": [],
                ...
                HealthState.FAILED,
                "PSU1's load is over 0.95, ",
                id="PSU 1 near 100% load. Health FAILED.",
            ),
            pytest.param(
                {
                    "board_temps": [],
                ...
                HealthState.FAILED,
                "PSU2's load is over 0.95, ",
                id="PSU 2 near 100% load. Health FAILED.",
            ),
            pytest.param(
                {
                    "board_temps": [],
                    ...
                    "power_supply_currents": [],
                    "tpm_voltages": [],
                    "power_supply_voltages": [0.0, 12.0],
                    "power_supply_loads": [0.0, 0.25],
                    "power_supply_voltages_in": [230.0, 230.0],
                    "power_supply_present": [True, True],
                    "tpm_power_states": [
                        PowerState.ON,
                ...
                HealthState.DEGRADED,
                "PSU1 is receiving voltage but not supplying any. "
                "Suspected defective PSU. ",
                id="PSU 1 dead. Health DEGRADED.",
            ),
            pytest.param(
                {
                    "board_temps": [],
                    ...
                    "power_supply_currents": [],
                    "tpm_voltages": [],
                    "power_supply_voltages": [12.0, 0.0],
                    "power_supply_voltages_in": [230.0, 230.0],
                    "power_supply_present": [True, True],
                    "power_supply_loads": [0.25, 0.0],
                    "tpm_power_states": [
                        PowerState.ON,
                        PowerState.ON,
                        PowerState.ON,
                ...
                HealthState.DEGRADED,
                "PSU2 is receiving voltage but not supplying any. "
                "Suspected defective PSU. ",
                id="PSU 2 dead. Health DEGRADED.",
            ),
            pytest.param(
                {
                    "board_temps": [],
                    ...
                    "board_currents": [],
                    "tpm_currents": [],
                    "power_supply_currents": [0.0, 0.0],
                    "tpm_voltages": [],
                    "power_supply_voltages": [0.0, 0.0],
                    "power_supply_voltages_in": [230.0, 230.0],
                    "power_supply_present": [True, True],
                    "power_supply_loads": [0.0, 0.0],
                    "tpm_power_states": [
                        PowerState.ON,
                        PowerState.ON,
                        PowerState.ON,
                ...
                HealthState.FAILED,
                "PSU1 is receiving voltage but not supplying any. "
                "Suspected defective PSU. PSU2 is receiving voltage but not "
                "supplying any. Suspected defective PSU. ",
                id="Both PSUs dead. Health FAILED.",
            ),
        ],
    )
        ...
        [
            pytest.param(
                ...
                },
                {
                    ...
                    "subrack_scaled_fan_speeds": [7000, 6500],
                    "board_currents": [14.0],
                    "tpm_currents": [3.0, 3.0, 3.0, 3.0, 3.0],
                    "power_supply_currents": [7.0, 7.0],
                ...
                {
                    "old_tpm_voltages": [5.0, 5.0, 5.0, 5.0],
                    "old_power_supply_voltages": [12.0, 12.0],
                    "old_tpm_power_states": [
                        PowerState.ON,
                        PowerState.ON,
                        PowerState.ON,
    ...
    @pytest.mark.parametrize(
        ...
        [
            pytest.param(
                ...
                {
                    "old_tpm_voltages": [5.0, 5.0, 5.0, 5.0],
                    "old_power_supply_voltages": [5.0, 5.0],
                    "old_tpm_power_states": [
                        PowerState.ON,
                        PowerState.ON,
                        PowerState.ON,
