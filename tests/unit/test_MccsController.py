...
class TestMccsController:
    ...
    def test_On(self, device_under_test, mock_callback, helpers):
        """
    ...
    def test_Off(self, device_under_test, mock_callback, helpers):
        """
    ...
    class TestAllocateRelease:
        ...
        def test_Allocate(self, device_under_test, mock_callback, helpers):
            """
        ...
        def test_Release(self, device_under_test, mock_callback, helpers):
            """
    ...
    def test_healthState(self, device_under_test, mock_callback, helpers):
        """
