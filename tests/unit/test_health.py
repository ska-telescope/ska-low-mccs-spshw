...
from ska.low.mccs.health import HealthMonitor, LocalHealthMonitor
...
class TestHealthMonitor:
    ...
    def test_initialise_table(self):
        ...
        :param fqdns: fully qualified device names to be monitored
        """
    ...
    def test_update_health(self, request):
        ...
        hm.update_health_table(fqdns[1], "healthstate", request, AttrQuality.ATTR_VALID)
        dct = hm.get_healthstate_table()
        assert dct == {
            "low/elt/station_1": {"State": DevState.UNKNOWN, "healthstate": request},
