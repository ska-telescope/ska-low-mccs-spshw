...
class TestTileHealthModel:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ({}, HealthState.OK, {"voltage": {"AVDD3": 3.4}}, HealthState.FAILED),
            (
                {"current": {"FE0_mVA": 2.5}},
                HealthState.FAILED,
                {"current": {"FE0_mVA": 2.1}},
    ...
    @pytest.mark.parametrize(
        ...
        [
            ({}, HealthState.OK, {"voltage": {"MON_3V3": {"min": 1}}}, HealthState.OK),
            (
                {},
                HealthState.OK,
                {"temperature": {"FPGA1": {"min": 150, "max": 250}}},
                HealthState.FAILED,
            ),
            (
            ...
            (
                {"io": {"f2f_if": {"pll_lock_loss_count": {"Core0": 2}}}},
                HealthState.FAILED,
                {"io": {"f2f_if": {"pll_lock_loss_count": {"Core0": 5}}}},
                HealthState.FAILED,
            ),
        ],
    )
